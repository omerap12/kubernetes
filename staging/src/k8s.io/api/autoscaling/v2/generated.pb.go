...
func (m *MetricSourceReference) Reset() { *m = MetricSourceReference{} }
...
func (m *MetricSourceReference) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MetricSourceReference) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MetricSourceReference) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MetricSourceReference) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *MetricIdentifier) String() string {
	...
	s := strings.Join([]string{`&MetricIdentifier{`,
		...
		`Source:` + strings.Replace(this.Source.String(), "MetricSourceReference", "MetricSourceReference", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *MetricSourceReference) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&MetricSourceReference{`,
...
func (m *MetricIdentifier) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Source == nil {
				m.Source = &MetricSourceReference{}
			}
...
func (m *MetricSourceReference) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MetricSourceReference: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MetricSourceReference: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
