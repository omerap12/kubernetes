...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*autoscalingv2.MetricSourceReference)(nil), (*autoscaling.MetricSourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2_MetricSourceReference_To_autoscaling_MetricSourceReference(a.(*autoscalingv2.MetricSourceReference), b.(*autoscaling.MetricSourceReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*autoscaling.MetricSourceReference)(nil), (*autoscalingv2.MetricSourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_autoscaling_MetricSourceReference_To_v2_MetricSourceReference(a.(*autoscaling.MetricSourceReference), b.(*autoscalingv2.MetricSourceReference), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v2_MetricSourceReference_To_autoscaling_MetricSourceReference(in *autoscalingv2.MetricSourceReference, out *autoscaling.MetricSourceReference, s conversion.Scope) error {
	*out = *(*autoscaling.MetricSourceReference)(unsafe.Pointer(in))
	return nil
}

// Convert_v2_MetricSourceReference_To_autoscaling_MetricSourceReference is an autogenerated conversion function.
func Convert_v2_MetricSourceReference_To_autoscaling_MetricSourceReference(in *autoscalingv2.MetricSourceReference, out *autoscaling.MetricSourceReference, s conversion.Scope) error {
	return autoConvert_v2_MetricSourceReference_To_autoscaling_MetricSourceReference(in, out, s)
}

func autoConvert_autoscaling_MetricSourceReference_To_v2_MetricSourceReference(in *autoscaling.MetricSourceReference, out *autoscalingv2.MetricSourceReference, s conversion.Scope) error {
	*out = *(*autoscalingv2.MetricSourceReference)(unsafe.Pointer(in))
	return nil
}

// Convert_autoscaling_MetricSourceReference_To_v2_MetricSourceReference is an autogenerated conversion function.
func Convert_autoscaling_MetricSourceReference_To_v2_MetricSourceReference(in *autoscaling.MetricSourceReference, out *autoscalingv2.MetricSourceReference, s conversion.Scope) error {
	return autoConvert_autoscaling_MetricSourceReference_To_v2_MetricSourceReference(in, out, s)
}
